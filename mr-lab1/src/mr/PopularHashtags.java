...
public class PopularHashtags extends Configured implements Tool
{
    public static void main(String[] args) throws Exception
    {
        int res = ToolRunner.run(new Configuration(), new PopularHashtags(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception
    {
        ...
        Job job = new Job(conf, "PopularHashtags");
